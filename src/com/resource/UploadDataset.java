...
public class UploadDataset extends HttpServlet {
			...
			throws ServletException, IOException 
	{
		...
		String path  = "C:\\eclipse-workspace\\Flood_Pre\\WebContent\\Dataset";
			...
			while ((line = br.readLine()) != null) {
				...
				if (i != 1) {
					...
					String sql = "insert into dataset values('"+datas[0]+"','"+datas[1]+"','"+datas[2]+"','"+datas[3]+"','"+datas[4]+"','"+datas[5]+"','"+datas[6]+"','"+datas[7]+"','"+datas[8]+"','"+datas[9]+"',"+
							"'"+datas[10]+"','"+datas[11]+"','"+datas[12]+"','"+datas[13]+"','"+datas[14]+"','"+datas[15]+"','"+datas[16]+"','"+datas[17]+"','"+datas[18]+"','"+datas[19]+"',"+
							"'"+datas[20]+"','"+datas[21]+"','"+datas[22]+"')";
		...
		RequestDispatcher rd = request.getRequestDispatcher("ViewDataSet.jsp");
