...
<%
	String uname = (String)session.getAttribute("name");
 	...
 	PreparedStatement query=con.prepareStatement("select * from userreg where name='"+uname+"' ");                                               
 	ResultSet rs=query.executeQuery();
%>
<tr style="background: sandybrown;"><td>ID</td><td>User Name</td><td>E-Mail</td><td>Address</td><td>Mobile</td><td>Action</td></tr>
<%
	while(rs.next())
	{
		%>
			<tr>
				...
				<td><%=rs.getString("mobile") %></td>				
 				<td><a href="profileUpdate.jsp?id=<%=rs.getString("id") %>&&address=<%=rs.getString("address") %>&&mobile=<%=rs.getString("mobile") %>&&password=<%=rs.getString("password") %>">Update</a></td>
			</tr>
		<%
	 }
%>
