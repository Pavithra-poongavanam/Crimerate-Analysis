...
<%
 	...
 	PreparedStatement query=con.prepareStatement("select * from comp where st='waiting'");                                               
 	ResultSet rs=query.executeQuery();
%>
<tr style="background: sandybrown;"><td>ID</td><td>Name</td><td>Mobile</td><td>State</td><td>View Compliance</td><td>Date</td><td>Time</td><td>Seen</td></tr>
<%
	while(rs.next())
	{
		%>
			<tr>
 			...
 			<td><a href="up.jsp?sno1=<%=rs.getString("id") %>">Seen</a></td>
			</tr>
		<%
	 }
%>
...
<br><br>
<center><a href="adminHome.jsp">Click To Back</a></center>
          </div>
        </div>
