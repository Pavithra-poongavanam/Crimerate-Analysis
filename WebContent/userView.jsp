...
<%
 	...
 	PreparedStatement query=con.prepareStatement("select * from userreg ");                                               
 	ResultSet rs=query.executeQuery();
%>
<tr style="background: sandybrown;"><td>ID</td><td>User Name</td><td>E-Mail</td><td>Address</td><td>Mobile</td></tr>
<%
	while(rs.next())
	{
		%>
