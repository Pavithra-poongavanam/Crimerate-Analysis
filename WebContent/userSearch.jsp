      ...
      <div class="container">
        <div class="row mb-5 justify-content-center text-center"  data-aos="fade-up">
          <div class="col-7 text-center  mb-5">
            ...
            <p class="lead">User Search</p>
            
            <pre>
<input type="text" name="Keyword" required="required" style="color: brown;text-align: center;height: 47px;width: 559px;border-radius: 30px;border-bottom-left-radius: blue;border-color: blue;">
